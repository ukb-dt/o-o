...
| **[Ukb](https://ukb-dt.github.io/o-atl-o/)-[Fractal](https://ukb-dt.github.io/o-toplogy-o/) [Phase](https://ukb-dt.github.io/stack/)** | **[Symbol](https://ukb-dt.github.io/o-ukb-o/) / Expression**                | **Epistemic Role**                              | **Statistical Analogue**                          | **Interpretation / [Legacy](https://abikesa.github.io/1y/)**                                                                      | **Geocultural Resonance**                                                                                                              | **[Ontological](https://ukb-dt.github.io/ns/) [Layer](https://ukb-dt.github.io/invariance/)**                                                                       | **Physical Expression (Airport Anatomy)**                | **[Metabolic](https://ukb-dt.github.io/o-mapk-o/) Function**                                               |
| :-------------------- | :------------------------------------- | :---------------------------------------------- | :------------------------------------------------ | :----------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------ | :------------------------------------------------------- | :------------------------------------------------------------------- |
| **[Soil](https://ukb-dt.github.io/ci/) (θ′)**         | $(E, x)$                               | Observation / entropy intake                    | Raw data with contextual noise                    | The clinical or civic sensorium — experience entering the system                                 | **[Kampala](https://ukb-dt.github.io/ukb-bge-00/)** — primal sensorium; earth-rich, communal, and immediate — perception unfiltered, entropy alive `@Rx`                       | **[Intérieur](https://en.wikipedia.org/wiki/Internal_environment): Runways/Taxiways + Metabolism ([Catabolic](https://en.wikipedia.org/wiki/Metabolism#Catabolism) + [Anabolic](https://en.wikipedia.org/wiki/Night_flying_restrictions))**                                                             | [Earth](https://ukb-dt.github.io/engineering/)-contact kinetic substrate                          | Converts ground fuel into lift; kinetic coupling with atmosphere     |
| **[Roots](https://ukb-dt.github.io/cns/) (θ)**         | $E(t \mid x) + \varepsilon_x$          | [Encoding](https://ukb-dt.github.io/aids/) with error across contextual strata    | Conditional expectation with residuals            | Stratified path dependencies — biological, social, temporal, institutional contexts¹             | **Baltimore** — deep social encoding `@JH`; layered racial, economic, and historical variance forming identity                         | **PNS: Gates + Jetways + Stands**                                                                | Static connection between aircraft and terminal          | Anchors flow; exchanges mass, energy, and passengers                 |
| **[Trunk](https://ukb-dt.github.io/o-ai-o/) (Σ)**         | $\dfrac{dE_x}{dt}$                     | Gradient / point estimate                       | Expected value or estimator $\hat{\theta}$        | Coherent intention or intervention — the system’s direction of learning                          | **Centreville** — measured growth; suburban equilibrium, mid-scale control point of gradient `@Ukb`                                    | **Vertebrae/Plexuses: Concourses, Cervical-to-Sacral**                                                             | Structural compression of movement into ordered channels | Encodes and regulates flow (security, customs, ticketing, logistics) |
| **[Branches](https://ukb-dt.github.io/o-dt-o/) (h(t))**   | $\pm 1.96,\sqrt{\dfrac{d^2E_x}{dt^2}}$ | Second derivative: structured variance of paths | Variance–covariance geometry (error distribution) | Distributed intelligence — curvature of exploration; alternative trajectories as reasoning field | **Staten Island** — eccentric curvature; outlier intelligence within the metropolis, variance incarnate `@95CI`                        | **CNS: Terminal & Spine + Internal Movers + Airtrains + Service Corridors**                                         | Feedback and oscillation circuits inside the node        | Balances and redistributes flows dynamically                         |
| **[Canopy](https://ukb-dt.github.io/hopper/) ([ΔS](https://ukb-dt.github.io/ethos/))**       | $\int E_x,dt + \varepsilon_x t + C_x$  | Integration constant / equilibrium ledger       | Bias term or prior constant $C_x$                 | Institutional or ethical baseline — what persists after adaptation                               | **[Nairobi](https://ukb-dt.github.io/eac/)** — integrative canopy; synthesis of roots and sky, regional equilibrium and renewal `@PAR` | **[Extérieur](https://fr.wikipedia.org/wiki/Milieu_ext%C3%A9rieur): Façades + Arrivals/Departures + Road/Rail Interfaces + Parking/Logistics Belts** | External integration with urban metabolism               | Resolves entropy into social, economic, and informational value      |
